...
const JSON_SCHEMA_INSTRUCTION =
  ...
  'Public visé — très important : la personne qui va lire ce rapport ne connaît ' +
  "RIEN au web ni au marketing digital. Ce n'est pas un développeur, pas un " +
  "expert SEO — potentiellement quelqu'un qui découvre ces mots pour la " +
  'première fois. Donc :\n' +
  "- N'utilise JAMAIS un sigle ou un mot technique (SEO, HTTPS, balise meta, H1, " +
  'canonical, Open Graph, robots.txt, sitemap, JSON-LD, NAP...) sans expliquer ' +
  "aussitôt ce que ça veut dire en une poignée de mots simples, comme si tu " +
  "l'expliquais à un ami qui n'a jamais monté un site. Exemple : au lieu de " +
  '"la balise meta description est absente", écris "la courte description qui ' +
  "s'affiche sous votre lien dans Google est absente\".\n" +
  '- Explique le POURQUOI concret (qu\'est-ce que ça change pour un client qui ' +
  'cherche cette entreprise, pas juste "c\'est mauvais pour le SEO").\n' +
  '- Phrases courtes, un seul sujet par phrase, aucun jargon d\'agence ' +
  '("optimiser", "leviers", "quick win") — des mots du quotidien.';
